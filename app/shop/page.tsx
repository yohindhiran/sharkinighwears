  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-[1320px] px-5 py-14 md:px-10 md:py-20">
        <FadeIn className="flex flex-wrap items-center justify-between gap-4 border-y border-ink/10 py-4">
        ...
        {products.length ? (
          ...
          <FadeIn className="mt-16 border border-dashed border-ink/20 px-8 py-20 text-center">
